...
img = Image.open(r"Images/add.png")
add_btn = CTkButton(option_frame,text = "", image = CTkImage(dark_image=img, light_image=img),corner_radius = 100, width= 10,
                     command = lambda: (authentication()))
add_btn.place(x = 15, y = 15)
